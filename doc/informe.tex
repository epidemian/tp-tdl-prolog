...
\lstset{ 
    ...
    backgroundcolor=\color{blue!8}, % Un color suave de fondo (menos chocante que el frame=single)
...
Se puede observar que cuando la proposición no se cumple, el resultado es \emph{false}. 

Este es el tipo más sencillo de queries, es decir, verificar si se cumple una relación a partir de hechos. Mediante se presenten nuevas construcciones del lenguaje se mostrarán queries más complejas.
