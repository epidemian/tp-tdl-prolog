...
El tipo de cláusula más simple en Prolog es el \emph{hecho}. Respresenta una verdad en un programa. Por ejemplo.
\begin{lstlisting}
varon(pedro).
\end{lstlisting}
...
padre(zeus, apolo).
\end{lstlisting}
Que puede interpretarse como: la relación \lstinline|padre| se cumple para los elementos \lstinline|zeus| y \lstinline|apolo|. El término utilizado en Prolog para referirse a las relaciones es \emph{predicado} y para los elementos individuales \emph{átomo} (ver sección \ref{atomos}).
