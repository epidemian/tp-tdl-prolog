...
El programa ``N Reinas'' calcula todas las soluciones al problema de las N Reinas\cite{nreinas}, es decir, las cómo posicionar $n$ reinas en un tablero de ajedrez de $n \times n$. El código entero del programa es:
\begin{lstlisting}
generar(0, []).
